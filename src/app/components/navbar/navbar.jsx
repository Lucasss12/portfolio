...
export default function navbar() {
  return (
    <>
      <nav className='px-6 py-6 flex justify-between content-center bg-white shadow-sm text-lg font-semibold mb-28'>
        ...
        <ul className='flex items-center space-x-4'>
          ...
          <li>
            <Link href='/'><h1 className='py-1 px-3 hover:bg-slate-400 hover:bg-opacity-20 rounded-lg'>Projets</h1></Link>
          </li>
          <li>
